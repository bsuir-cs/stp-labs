...
- Если Вы не знакомы с осноами работы, то пройти [интерактивный курс по Git](https://githowto.com/ru), фиксируя результаты его прохождения у себя в репозитории.
