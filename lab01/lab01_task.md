# Курс “Современные технологии программирования”. <br/> Лабораторная работа 1. <br/> Введение в Git \& Python
...
2. Ознакомиться с синтаксисом языка Python в режиме "Crash Course".
    ...
    - в) C некоторыми особенностями реализации объектно-ориентированноой парадигмы в Python желательно ознакомиться на материале [на материале](https://devpractice.ru/python-lesson-14-classes-and-objects/). Фиксировать резульаты этого необходимо в отдельный файл **lab01_oop.py**.
    ...
    - д) Результаты вашей работы фиксируйте в репозитории созданном в пунтке 1 в папке lab01.
<!-- \
&nbsp; -->
