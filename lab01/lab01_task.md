...
- Если Вы не знакомы с основами работы с Git, то рекомендуется пройти [интерактивный курс по Git](https://githowto.com/ru), фиксируя результаты его прохождения у себя в репозитории.
- Для лучшего понимания темы "ветвления" можно также [заглянуть в проект "Learn Git Branching"](https://learngitbranching.js.org)
